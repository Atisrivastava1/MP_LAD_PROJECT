...
from services.dashboard_service import get_summary, get_risk_distribution, get_high_risk_projects, get_data_quality
...
def data_quality(
    ...
    return get_data_quality(db, current_user=_)
