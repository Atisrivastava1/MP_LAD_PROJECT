...
class _RiskAnalysisScreenState extends State<RiskAnalysisScreen> {
  ...
  Future<_AnalysisData> _loadData() async {
    ...
    final results = await Future.wait([
      ApiService.fetchProjectDetails(widget.projectId),
      ApiService.fetchAnomalies(widget.projectId),
    ]);
    return _AnalysisData(
      project: results[0] as dynamic,
      anomalies: results[1] as List<Anomaly>,
    );
  }
